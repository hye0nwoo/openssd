...
+ BAD_BLK_BMP_BYTES + PAGE_MAP_BYTES + VCOUNT_BYTES + BLOCK_MAP_BYTES + BLOCK_VCOUNT_BYTES)
...
#define BLOCK_MAP_ADDR		(VCOUNT_ADDR + VCOUNT_BYTES)			// block mapping table
//#define BLOCK_MAP_BYTES		((NUM_BANKS * NUM_BMAP_BLOCK * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)
#define BLOCK_MAP_BYTES		((NUM_BANKS * VBLKS_PER_BANK * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)

#define BLOCK_VCOUNT_ADDR	(BLOCK_MAP_ADDR + BLOCK_MAP_BYTES)
#define BLOCK_VCOUNT_BYTES	((NUM_BANKS * NUM_BMAP_BLOCK * sizeof(UINT16) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)
